...
<div id="w0m" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PRESTADOR  </h2>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Crear nuevo prestador','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de prestadores',
