    ...
    public function actionCreate()
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Crear nuevo tipo de ingreso",
                ...
                return [
                    ...
                    'title'=> "Crear nuevo tipo de ingreso",
                    'content'=>'<span class="text-success">Éxito al crear tipo de ingreso</span>',
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
    ...
    public function actionUpdate($id)
    {
        ...
        if($request->isAjax){
            ...
            */
            ...
            if($request->isGet){
                return [
                    'title'=> "Actualzar tipo de ingreso #".$id,
                ...
                return [
                 ...
                 return [
                    'title'=> "Actulizar tipo de ingreso #".$id,
                    'content'=>$this->renderAjax('update', [
                        'model' => $model,
                    ]),
                    'footer'=> Html::button('Cerrar',['class'=>'btn btn-default pull-left','data-dismiss'=>"modal"]).
