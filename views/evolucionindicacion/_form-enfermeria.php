...
<div class="x_panel">
    <div class="x_title">
        <h2> <?=$model->isNewRecord ? "<i class='glyphicon glyphicon-plus'></i> NUEVA EVOLUCIÓN ENFERMERIA" : "<i class='glyphicon glyphicon-pencil'></i> ACTUALIZAR EVOLUCIÓN" ; ?>
        </h2>
        <div class="clearfix">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_contentF">
                        <div class="evolucionindicacion-form">
                              ...
                              <div class="col-md-11 col-sm-12 col-xs-12 form-group">
                                <div class='col-sm-5'>
                                <?= $form->field($model, 'nombreusuario')->textInput(['value'=> Yii::$app->user->identity->usuario, 'readonly'=>true])->label(false); ?>
                              </div>
                              </div>
                                <?= $form->field($model, 'especialidad')->hiddenInput(['value' => 'ENFERMERIA'])->label(false) ?>
                                <?= $form->field($model, 'tiporegistro')->hiddenInput(['value' => 'evolucion'])->label(false) ?>
                                <?= $form->field($model, 'id_usuario')->hiddenInput(['value'=> Yii::$app->user->identity->id])->label(false) ;?>
                                <?= $form->field($model, 'enfermeria')->hiddenInput(['value' => 1])->label(false) ?>
