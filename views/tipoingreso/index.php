...
?>
<div  class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> TIPO DE INGRESOS  </h2>
      ...
      <?=GridView::widget([
          ...
          'toolbar'=> [
              ['content'=>
                  ...
                  ['role'=>'modal-remote','title'=> 'Crear tipo de ingreso','class'=>'btn btn-default']).
          ...
          'panel' => [
              'type' => 'primary',
              'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de tipo de ingresos',
