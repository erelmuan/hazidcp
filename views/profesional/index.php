...
<div id="w0m" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PROFESIONAL  </h2>
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['title'=> 'Crear nuevo profesional','class'=>'btn btn-default']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="glyphicon glyphicon-list"></i> Lista de profesionales',
