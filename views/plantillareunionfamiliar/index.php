...
/* @var $searchModel app\models\PlantillareunionfamiliarSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'Plantillareunionfamiliars';
...
<div id="w0m" class="x_panel">
  <div class="x_title"><h2><i class="fa fa-table"></i> PLANTILLA REUNION FAMILIAR  </h2>
  ...
  <div class="plantillareunionfamiliar-index">
          ...
          <?=GridView::widget([
              ...
              'toolbar'=> [
                  ['content'=>
                      ...
                      ['role'=>'modal-remote','title'=> 'Crear nuevo plantilla','class'=>'btn btn-default']).
